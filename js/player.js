export class MetingJSElementHooked extends HTMLElement {
    connectedCallback() {
    ...
    disconnectedCallback() {
        this.meta.lock === 'false' && window.players[this.url].destroy() && delete window.players[this.url]
    }
    _camelize(str) {
        return str
            .replace(/^[_.\- ]+/, '')
    ...
    _loadPlayer(data) {
        ...
        window.players[this.url] = new APlayer(options)
    }
}